...
cognitive_shocks:
	$(MAKE) -C tasks/cdp4_cognitive_shocks/code build

cognitive_counterfactual_fast:
	$(MAKE) -C tasks/cdp4_cognitive_counterfactual/code run_fast

cognitive_validate_fast:
	$(MAKE) -C tasks/cdp4_cognitive_counterfactual/code validate_fast

cognitive_report_fast:
	$(MAKE) -C tasks/cdp4_cognitive_counterfactual/code report_fast

cognitive_pipeline_fast:
	$(MAKE) -C tasks/cdp4_cognitive_counterfactual/code all
